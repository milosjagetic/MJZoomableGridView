...
class ViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        gridView.gridProperties.horizontalAxisAttributes = LineAttributes(color: UIColor(red: 172/255, green: 172/255, blue: 222/255, alpha: 1), divisor: 0, dashes: [30, 30, 10, 30, 30], lineWidth: 10, roundedCap: false)
        ...
        gridView.gridProperties.verticalAxisAttributes = LineAttributes(color: UIColor(red: 172/255, green: 172/255, blue: 222/255, alpha: 1), divisor: 0, dashes: [], lineWidth: 20, roundedCap: false)
    }
